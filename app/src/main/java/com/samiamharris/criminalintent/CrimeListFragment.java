...
public class CrimeListFragment extends ListFragment {
    ...
    //this will be an object that implements the Callbacks interface
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        mEmptyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Start CrimePager Activity if listview is empty
        ...
        listView.setMultiChoiceModeListener(new AbsListView.MultiChoiceModeListener() {
            ...
            public boolean onCreateActionMode(ActionMode mode, Menu menu) {
                //got this from the action mode because it has
                //special details for configuring the contextual action bar
                MenuInflater inflater = mode.getMenuInflater();
                inflater.inflate(R.menu.crime_list_item_context, menu);
                //if not true then the context bar won't be created
                return true;
            }
